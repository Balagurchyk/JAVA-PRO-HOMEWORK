package com.proftelran.org.homeworkseabattle;

import java.util.Arrays;
import java.util.Scanner;
/*
Класс SeaBattle почти готов и уже можно играть,осталось только разобраться как он работает и добавить
недостающую логику в два метода :
...
Все комментарии есть в классе, и общие правила игры тоже в классе SeaBattle.
...
11. Таким образом, возвращаемся в пункт 8, передавая ход друг другу, игроки пытаются как можно
